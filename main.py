...
class mywindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def label_10_response(self, pathImg):
        global img1, point1, point2, count, pointsMax
        ...
        cv2.imshow('src', img1)
        cv2.waitKey(0)
        (fp1, fp2, results) = make_mask_by_mouse.pro(event, x, y, flags, param, pathImg)
        self.count = 1
        self.fp1 = fp1
        self.fp2 = fp2
        ...
        self.label_10.setPixmap(img)  # 在axis中显示图片
        if results == '良性':
